...
const handleSaveChanges = async () => {
  ...
  if (!name || !description) {
    alert("Please enter both Department Name and Description.");
    return;
  }
  ...
  try {
    ...
    if (res?.success) {
      ...
      onClose(createdDept); // ✅ Send back created department
    } else {
      console.error("❌ Error creating department:", res?.message || "Unknown error");
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                onClick={() => handleSwitchChange("allowAdminToPostJobs", !formData.allowAdminToPostJobs)}
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                onClick={() => handleSwitchChange("enableAutoApproval", !formData.enableAutoApproval)}
                className={`w-11 h-6 flex items-center rounded-full p-1 duration-300 ${
